...
| [`tmux`](tmux/README.md) | Terminal multiplexer with Catppuccin theme, vim-style navigation, and agent traffic lights |
| [`pi`](pi/README.md) | pi coding agent extensions (tmux status reporting) |
...
stow fish nvim tmux ghostty claude lazydocker lazygit bin pi
