...
return {
  {
    ...
    opts = {
      servers = {
        ...
        -- sourcekit-lsp ships with the active Xcode toolchain (not Mason),
        -- so it can't be installed via Mason — disable Mason management.
        -- For Xcode projects it needs a buildServer.json (generated by
        -- xcode-build-server) to understand schemes/targets; see swift.lua.
